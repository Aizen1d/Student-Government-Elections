<template>
    ...
    <div class="components">
        <div class="row">
            <div class="col-6">
                <h2 class="my-1">
                    <span class="return" @click="returnPage">Insert Data</span> > Queues
                </h2>            
            </div>
        </div>   
        ...
        <BaseContainer class="item-container" :height="'auto'" :maxHeight="'500px'">
            <BaseTable class="item-table" 
                ...
                <tr v-for="(item, index) in queueData" v-if="isQueueSuccess" :key="index">
...
<script>
    ...
    export default {
        ...
        methods: {
            returnPage() {
                router.visit('/comelec/insert-data');
            },
            formatDate(date) {
